      ...
      <section className=" mx-auto w-100 my-9">
        <div className="md:w-3/2 xl:w-1/3 lg:w-1/2 mx-auto px-8 md:px-16">
          ...
          <form className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="bg-[#002D74] rounded-md text-white py-3 hover:scale-105 duration-300"
            >
              Login
            </button>
          </form>
          ...
          <div className="mt-3 text-xs flex justify-between items-center text-[#002D74]">
            ...
            <button className="py-3 px-8 bg-white border border-blue-800 rounded-md hover:scale-110 duration-300">
              Register
            </button>
          </div>
        </div>
